...
public abstract class BiGlobalRecurrenceDistancesExtractor extends BiRecurrenceDistancesExtractor{

	public static BiGlobalRecurrenceDistancesExtractor factory(boolean overlapping, boolean skipNgaps){
//		System.out.println("LimitedBiGlobalRecurrenceExtractor "+overlapping+" "+skipNgaps);
		//TODO
		if(overlapping){
			if(skipNgaps){
				//overlap, skip
				return new BiGlobalRecurrenceDistancesExtractor() {
...
//						System.out.println(pos_a+" "+pos_b);
						...
						int count = pos_a.length * pos_b.length;
