...
import igtools.gui2.dictionaries.*;
import igtools.common.sequence.B3LLSequence;
import igtools.common.sequence.B3Sequence;
import igtools.common.util.Parikh;
 ...
 * @author vbonnici
 */
public class ParikhSizesFrame extends javax.swing.JFrame {
     ...
     */
    public ParikhSizesFrame(WSSequence wsseq) {
        this.wsseq = wsseq;
        ...
        if(this.nelsa != null){
           ...
           try{
                ...
                for(int k=from_k; k<=to_k; k++){
                    Set<Vector4Int> classes = new TreeSet<Vector4Int>();
                    ParikhClasses.getParikhClasses(nelsa, k,classes);

                    sizes.put(k, classes.size());
                }
                ...
                for(Map.Entry<Integer, Integer> entry : sizes.entrySet()){
                    System.out.println(entry.getKey() +"\t"+ entry.getValue() + "\t"+Parikh.nofParikhClasses(entry.getKey()));
